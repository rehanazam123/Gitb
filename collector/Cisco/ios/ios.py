...
class IOS:
    ...
    def handle_power_data(self):
        ...
        if self.password_group_type.lower() == "ssh":
            ...
            commands = ["show power detail","show power inline","show power"]
            template_paths = [
                os.path.join(self.baseurl, "cisco_ios_show_power_details.textfsm"),
                os.path.join(self.baseurl, "cisco_ios_show_power.textfsm"),
                os.path.join(self.baseurl, "cisco_ios_show_power_inline.textfsm"),
                os.path.join(self.baseurl, "cisco_ios_show_power_v3.textfsm"),
    ...
    def handle_traffic_data(self):
        if self.password_group_type.lower() == "ssh":
            ssh = sshCommand(self.device, self.password_group)
            ssh.get_commands(["show interfaces","show snmp mib ifmib ifindex"])
            template_paths = [
                os.path.join(self.baseurl, "cisco_ios_show_interfaces.textfsm"),
                os.path.join(self.baseurl, "ios_show_snmp_mib_ifmib_ifindex.textfsm"),
            ]

            data_traffic = ssh.main2(template_paths)
