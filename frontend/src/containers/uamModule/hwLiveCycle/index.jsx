...
} from "../../../store/features/uamModule/hwLiveCycle/apis";
import { useSelector } from "react-redux";
import { selectTableData } from "../../../store/features/uamModule/hwLiveCycle/selectors";
...
const Index = () => {
  ...
  const handleExport = (optionType) => {
    if (optionType === "All Hw Live Cycle") {
      jsonToExcel(dataSource, "Hwlivecycle");
    } else if (optionType === "Template") {
      jsonToExcel([generateObject(dataKeys)], "hwlivecycle_template");
    }
    ...
    <Spin spinning={isFetchRecordsLoading || isDeleteRecordsLoading}>
      <div>
        ...
        <DefaultCard sx={{ width: `${width - 105}px` }}>
          <PageHeader pageName="Hw Live Cycle" buttons={buttons} />
          <DefaultTable
