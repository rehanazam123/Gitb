...
import { selectTableData } from '../../../store/features/uamModule/sfps/selector';
...
const Index = () => {
  ...
  const handleExport = (optionType) => {
    if (optionType === 'All Sfps') {
      jsonToExcel(dataSource, 'Sfps');
    } else if (optionType === 'Template') {
      jsonToExcel([generateObject(dataKeys)], 'sfps_template');
    }
  ...
  return (
    <CustomSpin spinning={isFetchRecordsLoading || isDeleteRecordsLoading}>
      <div>
        ...
        >
          <PageHeader pageName="Sfps" buttons={buttons} />
          <DefaultTable
