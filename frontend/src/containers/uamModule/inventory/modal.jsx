...
// import { fetchSiteNames } from '../../../services/rackServices';
    ...
    try {
      ...
      setPasswordGroup(
        res?.data?.data?.map((item) => {
          return {
            label: item?.password_group_name,
            value: item?.id,
          };
        })
      );
  ...
  const addRack = (values) => {
    try {
      ...
      Swal.fire({
        ...
        // customClass: {
        //   container:theme?.mode=="dark"?swal_alert_dark :swal_alert_light,
        //   title: 'custom-swal-title',
        //     confirmButton: 'custom-swal-button',
        // }
        // ,
